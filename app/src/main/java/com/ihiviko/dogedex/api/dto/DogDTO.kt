...
class DogDTO (  //este solo se encarga de recibir los datos de internet
    val id: Long,
    val index: Int,
    @field:Json(name ="name_en") val name: String, //le agregamos field para que no aparescan null
